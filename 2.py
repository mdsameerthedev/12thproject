...
class mainwindow:
    def __init__(self, win_name):
        ...
        self._accountFrame = ctk.CTkFrame(master=self.frame1, height=1045, width=500)
        self._accountFrame.grid(row=0, column=0, padx=5, pady=5)

        self.deposit2 = ctk.CTkFrame(master=self.frame1, height=1045, width=1045)
        self.deposit2.grid(row=0, column=1, pady=5,padx=100)
